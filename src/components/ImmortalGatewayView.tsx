    ...
    <div className="mx-auto max-w-6xl space-y-5">
      <section className="cosmic-card-gold rounded-3xl p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div><p className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#F5D77F]">Verified permanent storage</p><h1 className="mt-2 font-cinzel text-3xl font-bold text-[#FFF2A8]">Permanent Archive</h1><p className="mt-2 max-w-3xl text-sm text-[#C8B1E4]">Only authenticated archive jobs recorded by Aeterna appear here. No transaction, block, gateway, or confirmation values are simulated.</p></div>
