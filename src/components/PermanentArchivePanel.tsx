...
export function PermanentArchivePanel(){
  ...
  return <article className="cosmic-card rounded-2xl p-5">
    ...
    <p className="text-[10px] text-amber-100 mt-3">Files up to 100 MB are supported. Only browser-encrypted bytes are sent to permanent storage. Losing the passphrase makes the archive unrecoverable.</p>
